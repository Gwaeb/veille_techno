...
COLOR = (255, 64, 0)      # Default idle is orange
ALT_COLOR = (255, 64, 0)  # hit color is teal
SWING_COLOR = (255, 64, 0) #swing animation color is white
TOP_COLOR = (255, 64, 0)  #top color is yellow-green
...
IDLE_PULSE_BRIGHTNESS_MIN = 0  # Default minimum idle pulse brightness
